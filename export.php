...
<!-- <button class="btn btn-success " type="button" id="dropdownMenu1"  onclick="$('#tickets').tableExport({type:'csv',escape:'false'});"> Export to CSV</button> -->
  ...
  <div class="row" style="!important;overflow:scroll;">
    <table id="tickets" class="table table-striped table-bordered table-xl" style="width:100%">
                        <thead >  
                          <tr>  
